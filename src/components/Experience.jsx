            ...
            <div className="max-w-4xl mx-auto px-6">
                ...
                <div className="flex items-center gap-4 mb-16">
                    <h2 className="font-heading text-3xl md:text-4xl font-extrabold text-white">
                        05. <span className="bg-gradient-to-r from-indigo-400 to-purple-400 bg-clip-text text-transparent">Professional Experience</span>
                    </h2>
                        ...
                        <div key={i} className="relative mb-12 flex flex-col md:flex-row items-start md:items-center">
                            ...
                            >
                                <div className="glass-card p-6 relative group hover:border-indigo-500/25 transition-all">
                                    <div className="absolute top-4 right-4 text-[10px] font-bold text-slate-500 uppercase tracking-widest bg-slate-950 px-2 py-0.5 rounded border border-white/5">
                                        {exp.type}
                                    </div>
